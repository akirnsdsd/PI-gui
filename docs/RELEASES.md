...
This repository does not have a stable binary release yet. Until the first
release is published, build the app from source by following
[`README.md`](../README.md).

Future release artifacts will be published at:
https://github.com/akirnsdsd/PI-gui/releases
