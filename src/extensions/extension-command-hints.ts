...
const AUTO_RENAME_USAGE_HINT = "参数：config、test、init、regen、<名称>";
const VOICE_NOTIFY_USAGE_HINT =
	"不带参数时打开扩展设置；参数：status、reload、on、off、test <idle|permission|question|error>";
const VOICE_NOTIFY_CANONICAL_DESCRIPTION =
	"语音通知：不带参数时打开扩展设置，或使用 status/reload/on/off/test";
